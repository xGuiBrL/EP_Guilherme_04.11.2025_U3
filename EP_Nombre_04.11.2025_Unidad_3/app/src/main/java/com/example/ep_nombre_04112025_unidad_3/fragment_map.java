...
public class fragment_map extends Fragment implements OnMapReadyCallback {
    ...
    public void moveMarkerOnBrusco() {
        if (Marca == null) return;

        // Simulate new location
        LatLng newLocation = new LatLng(baseLocation.latitude - 0.05, baseLocation.longitude + 0.05);
        Marca.setPosition(newLocation);
        miMapa.animateCamera(CameraUpdateFactory.newLatLng(newLocation));
